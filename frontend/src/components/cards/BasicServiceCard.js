...
export const BasicServiceCard = ({ data, setRatingId }) => {
    ...
    return (
        <>
         <div style={{paddingRight: "2px", paddingLeft: "2px", padding: "3px" }}  className="col-xl-4 col-lg-6 col-sm-12 col-12  fadeInUp wow" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
