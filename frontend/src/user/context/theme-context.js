...
export const english_text = {
    ...
    about: {
        text1: 'Know About Us',
        text2: 'Welcome to SERA, a platform connecting professionals and qualified individuals with local and international users. Our team of experts work tirelessly to ensure that our platform is always up to date and running smoothly.',
        text3: 'We carefully vet all of our professionals to ensure that they have the qualifications and experience needed to provide top-quality service.',
        text4: 'Our goal is to make it easy for clients to find the professional they need, and for professionals to find the clients and projects they want.',
        ...
        text7: "Our goal is to make it easier for our clients to find the right professionals for their needs and to allow them to advertise their skills and services. Finding the right expert can be difficult, so it's our mission to make the process as simple and clear as possible so you can harness the power of finding the right expert for your project.",
        ...
        text15: 'We strive to instil confidence in users on the platform with our secure and reliable payment methods, at SIRA ALLE your privacy is in safe hands.',
    ...
    how_to: {
        text1: 'How To Create And Publish Your Services',
        text2: 'Register',
        text3: 'Create an account to get started, you will need to create an account on our platform. Click on the "Sign Up" button on the top right corner of the homepage',
        text4: 'Dashboard Setup',
        text5: 'Add your information once you have created your account, you will be directed to your account dashboard. Here you can add your personal information, including your qualifications, work experience, and skills.',
        text6: 'Choose Membership',
        text7: 'We offer three different membership types:',
        text8: 'Premium',
        text9: 'Standard',
        text10: 'Basic',
        text11: 'Creating Service',
        text12: 'Create a Service you want to release. In doing so you have to provide necessary informations for the service and be sure to keep your service up to date so that potential clients can easily understand your availability and budget.',
        text13: 'Publish Your Service!',
        text14: 'After you have completed all the above steps, you can now publish your service. But note that you can make it unavailable whenever you want from your dashboard.',
...
export const amhairc_text = {
    ...
    about: {
        ...
        text7: 'ተጠቃሚዎቻችን ለፍላጎታቸው ትክክለኛውን ባለሙያ እንዲያገኙ እና ባለሙያዎች ክህሎቶቻቸውን እና አገልግሎቶቻቸውን እንዲያሳዩ እንከን የለሽ ተሞክሮ ለማቅረብ ቆርጠን ተነስተናል።',
        text8: 'የአገልግሎት ቁርጠኝነት',
        text9: 'ለሚፈልጉት አገልግሎት ትክክለኛውን ባለሙያ ለማግኘት እና ለስላሳ ልምድን ለማረጋገጥ የእኛ ቁርጠኛ የደንበኞች አገልግሎት ቡድን ሁል ጊዜ ይገኛል።',
        ...
        text15: 'በአስተማማኝ እና አስተማማኝ የመክፈያ ዘዴዎቻችን በመድረክ ላይ በተጠቃሚዎች ላይ እምነት ለመፍጠር እንጥራለን፣ በSIRA ALLE ግላዊነትዎ ደህንነቱ በተጠበቀ እጅ ነው።',
        text16: 'የተሰጠ ድጋፍ',
        text17: 'የኛ የደንበኞች አገልግሎት ቡድን ለማንኛውም ጥያቄዎች ወይም ስጋቶች ለመርዳት ዝግጁ ነው። የእርስዎን አስተያየት ዋጋ እንሰጣለን እና የእኛን መድረክ ለማሻሻል በቋሚነት እየሰራን ነው።',
    }, 
    how_to: {
        text1: 'ወደ  ሥራለ  ሙያዊ ምዝገባ መመሪያ እንኳን በደህና መጡ። በዚህ ድህረገፅ ላይ በመምጣትዎ እጅግ በጣም ደስተኞች ነን። ይህ መመሪያ አንደባለሙያ እንዴት እንደሚመዘገቡ ይመራዎታል።',
        text2: '',
        text3: '4charity.jpg በዘህ መድረክ ላይ መመዝገብ ያስፈልግዎታል። ለመመዝገብ በመነሻ/በመጀመሪያ ገፅ  ከላይ በቀኝ በኩል የሚገኘውን  “ይመዝገቡ” ቁልፍ ይክፈቱት',
        text4: '',
