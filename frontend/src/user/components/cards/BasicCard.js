...
export const BasicCard = ({ data, cardCount = 3 }) => {
    ...
    switch (cardCount) {
        ...
        case 1:
            ...
            break;
        default:
            cardClass = "col-xl-4 col-lg-3 col-sm-4 col-10 fadeInUp wow"
    }
        ...
        <div className={cardClass} style={{ padding: '5px' }}>
            ...
            <div class="card" style={{ marginBottom: '2px' }} >
                <div class="card-body" style={{padding: "0.6rem"}}>
                    ...
                    {(professional?.availability == "Available" || professional?.availability == "" || professional?.availability == undefined) && <span class="badge bg-success" style={{ width: "100%" }}>{"Available"}</span>}
                    {(professional?.availability != "Available" && professional?.availability != "") && <span class="badge bg-danger" style={{ width: "100%" }}>{professional?.availability}</span>}
