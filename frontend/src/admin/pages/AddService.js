...
import { uploadImage } from '../../seller/api/uploadImage';
import { useEffect, useState } from "react"
import { useLocation, useNavigate } from 'react-router-dom'
import "../../seller/pages/service/editor.css"

import { RichTextEditor } from '@mantine/rte';
import { DetailPreview } from '../../seller/pages/service/DetailPreview';
import { PremiumServiceCardPreview } from '../../seller/pages/service/PremiumServiceCardPreview';
// import { categories } from '../../utils/category_list';
import { BasicServiceCard } from '../../seller/pages/service/BasicServiceCardPreview';
...
import { register_service } from '../api';
import { ADMIN_HIDDEN_URL } from '../../config';

export const AddService = ({ editing = false }) => {
    const location = useLocation()

    let state = location.state ? location.state : ""
    let type = state.serviceType
    ...
    const register = () => {
        ...
        register_service({ title, price, overview, category, subcategory, bio, city, specificAdress, detail, img, deliveryDay, professionalId, professionalFirstName, professionalLastName, professionalImage, professionalStatus, serviceType, professionalPhoneNumber, paymentType, latitude, longitude, status: 2 }, (res) => {
            if (res.success) {
