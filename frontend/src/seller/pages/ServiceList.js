...
import { professional_services } from '../api'
export const ServiceList = () => {
    ...
    useEffect(() => {
        professional_services(seller._id, (data) => {
            if (data.length > 0) {
                let tmp = data[0].service_data
                setServiceList(data[0].service_data)
            ...
            {/* <div class="row">
                <div class="col-lg-12">
                    <div class="dashboard-settings margin-top-40">
                        <h2 class="dashboards-title"> Services List</h2>
                    </div>
                </div>
            </div> */}
