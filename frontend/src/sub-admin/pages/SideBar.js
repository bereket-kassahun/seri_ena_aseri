        ...
        <>
            <div id="wrapper">
                <ul className={"navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " + (toggled ? 'toggled' : '')} id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <Link to='professionals_list' className={"nav-link " + (activePage == 1 ? 'active' : '')} onClick={() => { setActivePage(3); setTitle("Professionals") }}>
                            <a > <i class="las la-gifts"></i><span>Professionals</span> </a>
                        </Link>
                    </li>
                    <li class="nav-item">
                        <Link to='services_list' className={"nav-link " + (activePage == 2 ? 'active' : '')} onClick={() => { setActivePage(4); setTitle("Services") }}>
                            <a > <i class="las la-gifts"></i><span>Services</span> </a>
                        </Link>
                    </li>
                    <li class="nav-item">
                        <Link to='register_professional' className={"nav-link " + (activePage == 3 ? 'active' : '')} onClick={() => { setActivePage(5); setTitle("Register Professional") }}>
                            <a > <i class="las la-gifts"></i><span>Register Professional</span> </a>
                        </Link>
                    </li>
                    <li class="nav-item">
                        <Link to='create_service' className={"nav-link " + (activePage == 4 ? 'active' : '')} onClick={() => { setActivePage(6); setTitle("Create Service") }}>
                            <a > <i class="las la-gifts"></i><span>Create Service</span> </a>
                        </Link>
                    </li>
                    
                    <li class="nav-item">
                        <Link  className={"nav-link " + (activePage == 5 ? 'active' : '')} onClick={() => { adminLogout() }}>
